    ...
    <div class="flex flex-col relative w-screen">
        <div id="menu" class="bg-primary-100 min-h-screen z-10 text-slate-300 w-64 fixed left-0 h-screen">
           <div id="nav" class="w-full px-6">
            ...
            <a href="/paiements" class="w-full px-2 inline-flex space-x-6 items-center border-b border-cyan-700 py-3 hover:bg-primary-300 hover:text-cyan-500 transition ease-linear duration-150">
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className='size-10' viewBox="0 0 576 512"><path fill="#00808c" d="M64 32C28.7 32 0 60.7 0 96l0 32 576 0 0-32c0-35.3-28.7-64-64-64L64 32zM576 224L0 224 0 416c0 35.3 28.7 64 64 64l448 0c35.3 0 64-28.7 64-64l0-192zM112 352l64 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-64 0c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16l128 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-128 0c-8.8 0-16-7.2-16-16z"/></svg>
                </div>
                <div class="flex flex-col">
                    <span class="text-lg text-black font-bold leading-5 pt-1">Paiements</span>
                    <span class="text-sm text-black/50 hidden md:block">La liste des paiements.</span>
                </div>
            </a>

            <a href="/devices" class="w-full px-2 inline-flex space-x-6 items-center border-b border-cyan-700 py-3 hover:bg-primary-300 hover:text-cyan-500 transition ease-linear duration-150">
                <div>
                ...
                <div class="flex flex-col">
                    <span class="text-lg text-black font-bold leading-5 pt-1">Equipements</span>
